...
from src.account import yob_from_pesel
...
class TestAccount:
    ...
    def test_pesel_length(self):
        ...
        account3 = Account("John", "Doe", "06211304545", 200.0)
    ...
    def test_is_code_correct_format(self):
        account1 = Account("John", "Doe", "06211304545", 200.0, "AAA_aa")
        account2 = Account("John", "Doe", "06211304545", 200.0, "aa")
        account3 = Account("John", "Doe", "06211304545", 200.0, "PROM_aa")
        account4 = Account("John", "Doe", "06211304545", 200.0, "prom_xyz")
    ...
    def test_does_code_work_for_seniors(self):
        account1 = Account("John", "Doe", "59121304545", 200.0, "PROM_XYZ")
        account2 = Account("John", "Doe", "20121304545", 200.0, "PROM_XYZ")
        assert account1.balance == 200
        assert account2.balance == 200
