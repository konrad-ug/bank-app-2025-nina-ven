...
Scenario: User is able to update name of already created account
    Given Account registry is empty
    And I create an account using name: "mary", last name: "mayers", pesel: "96092909872"
    When I update "name" of account with pesel: "96092909872" to "magdalena"
    Then Account with pesel "96092909872" has "name" equal to "magdalena"
